...
const ProtectedLayout = () => {
    ...
    const handleEditRole = (id: number, updated: Omit<Role, 'id' | 'createdAt'>) => {
        setRoles((prev) => prev.map((role) => (role.id === id ? { ...role, ...updated } : role)));
    };
        ...
        >
            ...
            >
                <div
                    ...
                    style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', height: 0 }}
                >
                    <Routes>
                        {/* Dashboard */}
                        <Route
                        ...
                        <Route
                            ...
                            element={<RolesPermissions roles={roles} onDelete={handleDeleteRole} />}
                        />
                        <Route
                        ...
                        <Route path="/masters/beacon-devices/add" element={<AddBeaconDevice />} />
                        <Route
                        ...
                        <Route
                            path="/Organisation/edit/institution/:id"
