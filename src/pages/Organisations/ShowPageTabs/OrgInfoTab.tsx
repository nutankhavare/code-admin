...
const StatusBadge = ({ status }: { status?: string }) => {
    ...
    return (
        <span
            className={`inline-flex items-center gap-1 p-1 rounded-lg text-sm font-bold uppercase border-2 ${
                isActive
        ...
        >
            <span
                className={`w-2 h-2 rounded-full ${isActive ? 'bg-green-500' : 'bg-red-500'} animate-pulse`}
            ></span>
        ...
        <div className="space-y-4 mt-2 pb-10">
            ...
            <div className="overflow-y-auto h-[78vh] space-y-2 border border-gray-200 rounded-lg p-4">
                ...
                <div className="bg-white rounded-md shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                    <SectionHeader icon={<FaInfoCircle size={20} />} title="Basic Information" />
                        ...
                        {entity.type === 'office' && (
                            <>
                                <DetailItem
                                    ...
                                    value={(entity as OfficeData).organisation_name}
                                />
                                <DetailItem
                                    label="Organisation Type"
                                    value={(entity as OfficeData).organisation_type}
                                />
                                <DetailItem
                                    label="Registration Type"
                                    value={(entity as OfficeData).registration_type}
                                />
                                <DetailItem
                                    label="Registration Number"
                                    value={(entity as OfficeData).registration_number}
                                />
                                <DetailItem
                                    label="Registration Date"
                                    value={formatDate((entity as OfficeData).registration_date)}
                                />
                                <DetailItem
                                    label="GST Number"
                                    value={(entity as OfficeData).gst_number}
                                />
                                <DetailItem
                                    label="PAN Number"
                                    value={(entity as OfficeData).pan_number}
                                />
                                <DetailItem
                                    label="Tan Number"
                                    value={(entity as OfficeData).tan_number}
                                />
                                <DetailItem
                                    label="UDYAM / MSME No."
                                    value={(entity as OfficeData).udyam_msme_registration_no}
                                />
                                <DetailItem
                                    label="Email"
                                    value={(entity as OfficeData).organisation_email}
                                />
                                <DetailItem
                                    label="Phone"
                                    value={(entity as OfficeData).organisation_phone}
                                />
                            </>
                        )}
                        ...
                        {entity.type === 'institution' && (
                            <>
                                <DetailItem
                                    ...
                                    value={(entity as InstitutionData).institution_name}
                                />
                                <DetailItem
                                    label="Institution Type"
                                    value={(entity as InstitutionData).institution_type}
                                />
                                <DetailItem
                                    label="Affiliation Board"
                                    value={(entity as InstitutionData).affiliation_board_university}
                                />
                                <DetailItem
                                    label="Registration Type"
                                    value={(entity as InstitutionData).registration_type}
                                />
                                <DetailItem
                                    label="Registration Number"
                                    value={(entity as InstitutionData).registration_number}
                                />
                                <DetailItem
                                    label="Registration Date"
                                    value={formatDate(
                                        (entity as InstitutionData).registration_date
                                    )}
                                />
                                <DetailItem
                                    label="UDISE / College Code"
                                    value={(entity as InstitutionData).udise_code_college_code}
                                />
                                <DetailItem
                                    label="GST Number"
                                    value={(entity as InstitutionData).gst_number}
                                />
                                <DetailItem
                                    label="PAN Number"
                                    value={(entity as InstitutionData).pan_number}
                                />
                            </>
                        )}
                        ...
                        {entity.type === 'motor_driving_school' && (
                            <>
                                <DetailItem
                                    ...
                                    value={(entity as MotorDrivingSchoolData).driving_school_name}
                                />
                                <DetailItem
                                    label="License Number (RTO)"
                                    value={(entity as MotorDrivingSchoolData).license_number_rto}
                                />
                                <DetailItem
                                    label="License Issue Date"
                                    value={formatDate(
                                        (entity as MotorDrivingSchoolData).license_issue_date
                                    )}
                                />
                                <DetailItem
                                    label="License Expiry Date"
                                    value={formatDate(
                                        (entity as MotorDrivingSchoolData).license_expiry_date
                                    )}
                                />
                                <DetailItem
                                    label="Registration Type"
                                    value={(entity as MotorDrivingSchoolData).registration_type}
                                />
                                <DetailItem
                                    label="Registration Number"
                                    value={(entity as MotorDrivingSchoolData).registration_number}
                                />
                                <DetailItem
                                    label="Registration Date"
                                    value={formatDate(
                                        (entity as MotorDrivingSchoolData).registration_date
                                    )}
                                />
                                <DetailItem
                                    label="PAN Number"
                                    value={(entity as MotorDrivingSchoolData).pan_number}
                                />
                                <DetailItem
                                    label="GST Number"
                                    value={(entity as MotorDrivingSchoolData).gst_number}
                                />
                                <DetailItem
                                    label="Driving School Email"
                                    value={(entity as MotorDrivingSchoolData).driving_school_email}
                                />
                                <DetailItem
                                    label="Driving School Phone"
                                    value={(entity as MotorDrivingSchoolData).driving_school_phone}
                                />
                                <DetailItem
                                    label="UDYAM / MSME No."
                                    value={
                                        (entity as MotorDrivingSchoolData)
                                            .udyam_msme_registration_no
                                    }
                                />
                            </>
                        )}
                ...
                <div className="bg-white rounded-md shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                    <SectionHeader icon={<FaCogs size={20} />} title="Operational Details" />
                            ...
                            <>
                                <div className="bg-linear-to-br from-blue-50 to-blue-100 p-4 rounded-lg border-2 border-blue-200">
                                    ...
                                    <p className="text-2xl font-bold text-blue-900">
                                        {(entity as OfficeData).number_of_employees || 0}
                                    </p>
                                </div>
                                <div className="bg-linear-to-br from-green-50 to-green-100 p-4 rounded-lg border-2 border-green-200">
                                    ...
                                    <p className="text-2xl font-bold text-green-900">
                                        {(entity as OfficeData).number_of_vehicles || 0}
                                    </p>
                                </div>
                  ...
                  <p className="text-2xl font-bold text-purple-900">{(entity as OfficeData).number_of_travellers || 0}</p>
                                ...
                                <div className="bg-linear-to-br from-orange-50 to-orange-100 p-4 rounded-lg border-2 border-orange-200">
                                    ...
                                    <p className="text-2xl font-bold text-orange-900">
                                        {(entity as OfficeData).number_of_gps || 0}
                                    </p>
                                </div>
                                <div className="bg-linear-to-br from-pink-50 to-pink-100 p-4 rounded-lg border-2 border-pink-200">
                                    ...
                                    <p className="text-2xl font-bold text-pink-900">
                                        {(entity as OfficeData).number_of_beacons || 0}
                                    </p>
                                </div>
                                ...
                                <div className="col-span-2 bg-linear-to-br from-purple-50 to-purple-100 p-4 rounded-lg border-2 border-purple-200">
                                    ...
                                    {Array.isArray((entity as OfficeData).working_days) &&
                                    (entity as OfficeData).working_days.length > 0 ? (
                                ...
                                <div className="bg-linear-to-br from-red-50 to-red-100 p-4 rounded-lg border-2 border-red-200">
                                    ...
                                    <p className="text-2xl font-bold text-red-900">
                                        {(entity as OfficeData).working_hours || 0}
                                    </p>
                                </div>
                            </>
                        )}
                        ...
                        {entity.type === 'institution' && (
                            <>
                                <div className="bg-linear-to-br from-blue-50 to-blue-100 p-4 rounded-lg border-2 border-blue-200">
                                    ...
                                    <p className="text-2xl font-bold text-blue-900">
                                        {(entity as InstitutionData).number_of_students || 0}
                                    </p>
                                </div>
                                <div className="bg-linear-to-br from-green-50 to-green-100 p-4 rounded-lg border-2 border-green-200">
                                    <p className="text-xs text-green-600 uppercase font-semibold mb-1">
                                    ...
                                    <p className="text-2xl font-bold text-green-900">
                                        {(entity as InstitutionData).number_of_staff || 0}
                                    </p>
                                </div>
                                <div className="bg-linear-to-br from-purple-50 to-purple-100 p-4 rounded-lg border-2 border-purple-200">
                                    ...
                                    <p className="text-2xl font-bold text-purple-900">
                                        {(entity as InstitutionData).number_of_vehicles || 0}
                                    </p>
                                </div>
                                <div className="bg-linear-to-br from-orange-50 to-orange-100 p-4 rounded-lg border-2 border-orange-200">
                                    <p className="text-xs text-orange-600 uppercase font-semibold mb-1">
                                    ...
                                    <p className="text-2xl font-bold text-orange-900">
                                        {(entity as InstitutionData).number_of_gps || 0}
                                    </p>
                                </div>
                                <div className="bg-linear-to-br from-pink-50 to-pink-100 p-4 rounded-lg border-2 border-pink-200">
                                    <p className="text-xs text-pink-600 uppercase font-semibold mb-1">
                                    ...
                                    <p className="text-2xl font-bold text-pink-900">
                                        {(entity as InstitutionData).number_of_beacons || 0}
                                    </p>
                                </div>
                            </>
                        )}
                        ...
                        {entity.type === 'motor_driving_school' && (
                            <>
                                <div className="bg-linear-to-br from-blue-50 to-blue-100 p-4 rounded-lg border-2 border-blue-200">
                                    ...
                                    <p className="text-2xl font-bold text-blue-900">
                                        {(entity as MotorDrivingSchoolData).number_of_vehicles || 0}
                                    </p>
                                </div>
                                <div className="bg-linear-to-br from-green-50 to-green-100 p-4 rounded-lg border-2 border-green-200">
                                    <p className="text-xs text-green-600 uppercase font-semibold mb-1">
                                    ...
                                    <p className="text-2xl font-bold text-green-900">
                                        {(entity as MotorDrivingSchoolData).number_of_trainers || 0}
                                    </p>
                                </div>
                                <div className="bg-linear-to-br from-purple-50 to-purple-100 p-4 rounded-lg border-2 border-purple-200">
                                    <p className="text-xs text-purple-600 uppercase font-semibold mb-1">
                                    ...
                                    <p className="text-2xl font-bold text-purple-900">
                                        {(entity as MotorDrivingSchoolData).number_of_students || 0}
                                    </p>
                                </div>
                                <div className="bg-linear-to-br from-orange-50 to-orange-100 p-4 rounded-lg border-2 border-orange-200">
                                    <p className="text-xs text-orange-600 uppercase font-semibold mb-1">
                                    ...
                                    <p className="text-2xl font-bold text-orange-900">
                                        {(entity as MotorDrivingSchoolData).number_of_gps || 0}
                                    </p>
                                </div>
                                <div className="bg-linear-to-br from-pink-50 to-pink-100 p-4 rounded-lg border-2 border-pink-200">
                                    <p className="text-xs text-pink-600 uppercase font-semibold mb-1">
                                    ...
                                    <p className="text-2xl font-bold text-pink-900">
                                        {(entity as MotorDrivingSchoolData).number_of_beacons || 0}
                                    </p>
                                </div>
                            </>
                        )}
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-white rounded-md shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                        <SectionHeader icon={<FaUserTie size={20} />} title="Contact Persons" />
                        ...
                        <div className="p-4">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-4">
                                ...
                                <DetailItem
                                    ...
                                    value={entity.primary_person_phone_1}
                                />
                                <DetailItem
                                    label="Secondary Number"
                                    value={entity.primary_person_phone_2}
                                />
                            </div>
                        </div>
                        ...
                        <div className="p-4 ">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-4">
                                ...
                                <DetailItem
                                    label="Primary Number"
                                    value={entity.secondary_person_phone_1}
                                />
                                <DetailItem
                                    label="Secondary Number"
                                    value={entity.secondary_person_phone_2}
                                />
                            </div>
                        </div>
                    </div>
