...
import { FiFileText, FiMapPin, FiUser, FiSettings, FiAlignLeft, FiInfo, FiBriefcase, FiLock, FiFolder, FiMap, FiPhone, FiCheckCircle } from "react-icons/fi";
...
const MotorDrivingSchoolCreateForm = () => {
  ...
  return (
    <div className="rp-form-card rp-form-wide">
      ...
      <div className="rp-section" style={{ borderBottom: "none", paddingBottom: 0 }}>
        <div className="rp-section-body">
          <div style={{
            ...
            <div>
              <p style={{ fontSize: "0.75rem", fontWeight: 700, color: "#1e40af", textTransform: "uppercase" }}>Onboarding New MDS</p>
      ...
      <div className="rp-section">
        <div className="rp-section-title">
          <FiSettings className="rp-section-icon" style={{ color: "#8b5cf6" }} /> OPERATIONAL & SAFETY MAPPING
        </div>
        <div className="rp-section-body">
          <div className="rp-grid-3">
            <InputField
      ...
      <div className="rp-section">
        <div className="rp-section-title">
          <FiCheckCircle className="rp-section-icon" style={{ color: "#64748b" }} /> REMARKS & CONSENT
        </div>
        <div className="rp-section-body">
          <div
