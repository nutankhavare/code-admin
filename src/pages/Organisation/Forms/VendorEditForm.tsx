...
import { FiShoppingBag, FiPhone, FiMapPin, FiFileText, FiCreditCard, FiBriefcase, FiTruck, FiAlignLeft, FiInfo } from "react-icons/fi";
    ...
    <div className="rp-form-card rp-form-wide">
      ...
      <div className="rp-section" style={{ borderBottom: "none", paddingBottom: 0 }}>
        <div className="rp-section-body">
          <div style={{
            ...
            <div>
              <p style={{ fontSize: "0.75rem", fontWeight: 700, color: "#9a3412", textTransform: "uppercase" }}>Editing Vendor Details</p>
              <p style={{ fontSize: "0.72rem", color: "#c2410c", textTransform: "uppercase", marginTop: "0.125rem" }}>Update fields as needed. All changes are tracked.</p>
            </div>
          </div>
      ...
      <div className="rp-section">
        <div className="rp-section-title">
          <FiShoppingBag className="rp-section-icon" style={{ color: "#f97316" }} /> VENDOR DETAILS
        </div>
        <div className="rp-section-body">
          <div className="rp-grid-2">
            <InputField label="Vendor Name" name="organisation_name" register={register} errors={errors} required />
            <InputField label="Vendor Type" name="vendor_type" register={register} errors={errors} placeholder="Individual / Company / Trust / Cooperative" required />
          </div>
        </div>
      </div>
      ...
      <div className="rp-section">
        <div className="rp-section-title">
          <FiPhone className="rp-section-icon" style={{ color: "#3b82f6" }} /> CONTACT DETAILS
        </div>
        <div className="rp-section-body">
          <div className="rp-grid-3">
            <InputField label="Contact Person Name" name="primary_person_name" register={register} errors={errors} required />
            <InputField label="Contact Mobile" name="contact_mobile" register={register} errors={errors} required />
      ...
      <div className="rp-section">
        <div className="rp-section-title">
          <FiMapPin className="rp-section-icon" style={{ color: "#ef4444" }} /> OFFICE ADDRESS
        </div>
        <div className="rp-section-body">
          <div className="rp-grid-3">
            ...
            <InputField label="Village / Locality" name="landmark" register={register} errors={errors} />
      ...
      <div className="rp-section">
        <div className="rp-section-title">
          <FiFileText className="rp-section-icon" style={{ color: "#6366f1" }} /> COMPLIANCE DETAILS
        </div>
        <div className="rp-section-body">
          <div className="rp-grid-2">
            <InputField label="GST Number" name="gst_number" register={register} errors={errors} required />
            <InputField label="PAN Number" name="pan_number" register={register} errors={errors} required />
            <InputField label="Aadhaar Number" name="aadhaar_number" register={register} errors={errors} />
            <InputField label="UDYAM / MSME No." name="msme_number" register={register} errors={errors} />
          </div>
        </div>
      </div>
      ...
      <div className="rp-section">
        <div className="rp-section-title">
          <FiCreditCard className="rp-section-icon" style={{ color: "#10b981" }} /> BANK DETAILS
        </div>
        <div className="rp-section-body">
          <div className="rp-grid-3">
      ...
      <div className="rp-section">
        <div className="rp-section-title">
          <FiBriefcase className="rp-section-icon" style={{ color: "#f59e0b" }} /> CONTRACT DETAILS
        </div>
        <div className="rp-section-body">
          <div className="rp-grid-3">
            <InputField label="Start Date" name="contract_start_date" type="date" register={register} errors={errors} required />
            <InputField label="End Date" name="contract_end_date" type="date" register={register} errors={errors} required />
            <InputField label="Insurance Coverage" name="insurance_coverage" register={register} errors={errors} placeholder="Yes / No" required />
          </div>
        </div>
      </div>
      ...
      <div className="rp-section">
        <div className="rp-section-title">
          <FiTruck className="rp-section-icon" style={{ color: "#ef4444" }} /> VEHICLE DETAILS
        </div>
        <div className="rp-section-body">
          <div className="rp-grid-3">
            <InputField label="Vehicle Count" name="vehicle_count" type="number" register={register} errors={errors} required />
            <InputField label="Vehicle Numbers" name="vehicle_numbers" register={register} errors={errors} placeholder="KA01AB1234, KA02CD5678" required />
