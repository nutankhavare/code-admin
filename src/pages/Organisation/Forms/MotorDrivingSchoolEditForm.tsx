                ...
                <div className="rp-section-body">
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                Editing Driving School Details
                            </p>
                            <p
                                style={{
                                    fontSize: '0.72rem',
            ...
            <div className="rp-section">
                ...
                <div className="rp-section-body">
                    <div className="rp-grid-3">
                        ...
                        />
                        <FileInputField
                            label="RTO License Doc"
                            name="license_certificate_doc"
                            register={register}
                            errors={errors}
                            existingFile={
                                typeof existingDocs.license_certificate_doc === 'string'
                                    ? existingDocs.license_certificate_doc
                                    : undefined
                            }
                        />
                        <FileInputField
                            ...
                            errors={errors}
                            existingFile={
                                typeof existingDocs.gst_certificate_doc === 'string'
                                    ? existingDocs.gst_certificate_doc
                                    : undefined
                            }
                        />
                        <FileInputField
                        ...
                        <FileInputField
                            ...
                            name="udyam_msme_certificate_doc"
                            register={register}
                            errors={errors}
                            existingFile={
                                typeof existingDocs.udyam_msme_certificate_doc === 'string'
                                    ? existingDocs.udyam_msme_certificate_doc
                                    : undefined
                            }
                        />
                        <FileInputField
