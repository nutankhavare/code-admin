  ...
  return (
    <div className="rp-form-card rp-form-wide">
      ...
      <div className="rp-section" style={{ borderBottom: "none", paddingBottom: 0 }}>
        <div className="rp-section-body">
          <div style={{
            ...
            <div>
              <p style={{ fontSize: "0.75rem", fontWeight: 700, color: "#1e40af", textTransform: "uppercase" }}>Editing Institution Details</p>
      ...
      <div className="rp-section">
        ...
        <div className="rp-section-body">
          <div className="rp-grid-4">
            <InputField label="Institution Name" name="institution_name" register={register} errors={errors} required />
            <InputField label="Institution Type" name="institution_type" register={register} errors={errors} />
            <InputField label="Affiliation Board / University" name="affiliation_board_university" register={register} errors={errors} />
            ...
            <InputField label="UDISE Code / College Code" name="udise_code_college_code" register={register} errors={errors} />
            ...
            <InputField label="Institution Email" name="institution_email" type="email" register={register} errors={errors} required />
            <InputField label="Institution Phone" name="institution_phone" register={register} errors={errors} required />
            <InputField label="Website Domain" name="domain" register={register} errors={errors} placeholder="e.g. greenvalley" />
      ...
      <div className="rp-section">
        ...
        <div className="rp-section-body">
          <div className="rp-grid-4">
            <InputField label="Students" name="number_of_students" type="number" register={register} errors={errors} />
            <InputField label="Staff" name="number_of_staff" type="number" register={register} errors={errors} />
      ...
      <div className="rp-section">
        ...
        <div className="rp-section-body">
          <div className="rp-grid-3">
            ...
            <FileInputField label="UDISE / College Code Proof" name="udise_code_college_code_doc" register={register} errors={errors} existingFile={typeof existingDocs.udise_code_college_code_doc === 'string' ? existingDocs.udise_code_college_code_doc : undefined} />
            ...
            <FileInputField label="Driver Vetting Policy" name="driver_vetting_policy_doc" register={register} errors={errors} existingFile={typeof existingDocs.driver_vetting_policy_doc === 'string' ? existingDocs.driver_vetting_policy_doc : undefined} />
            <FileInputField label="Subscription Agreement" name="subscription_agreement_doc" register={register} errors={errors} existingFile={typeof existingDocs.subscription_agreement_doc === 'string' ? existingDocs.subscription_agreement_doc : undefined} />
