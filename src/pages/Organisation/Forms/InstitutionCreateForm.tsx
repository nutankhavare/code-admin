...
import { FiFileText, FiMapPin, FiUser, FiSettings, FiAlignLeft, FiInfo, FiBriefcase, FiLock, FiFolder, FiMap, FiAward } from "react-icons/fi";
    ...
    <div className="rp-form-card rp-form-wide">
      ...
      <div className="form-section" style={{ borderBottom: "none", paddingBottom: 0 }}>
        <div className="form-section-body">
          <div style={{
            ...
            <div>
              <p style={{ fontSize: "0.75rem", fontWeight: 700, color: "#1e40af", textTransform: "uppercase" }}>Onboarding New Institution</p>
      ...
      <div className="form-section">
        ...
        <div className="form-section-body">
          ...
          <div className="rp-info-banner" style={{ background: "#fef3c7", color: "#92400e", marginTop: "1rem" }}>
