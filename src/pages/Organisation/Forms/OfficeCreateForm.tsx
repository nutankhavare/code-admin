...
import { FiFileText, FiMapPin, FiUser, FiSettings, FiAlignLeft, FiInfo, FiBriefcase, FiLock, FiFolder, FiMap } from "react-icons/fi";
...
const OfficeCreateForm = () => {
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      try {
        setLoading(true);
        const [plansRes, orgTypesRes, regTypesRes, statesRes] =
          await Promise.all([
        ...
        setPlans([{ id: 1, name: "Starter", price: 999, billing: "Monthly", users: 10, features: [], status: "Active", subscribers: 0 }]);
        setOrganisationTypes([{ label: "Private Limited", value: "Private Limited" }]);
        setRegistrationTypes([{ label: "Company", value: "Company" }, { label: "Partnership", value: "Partnership" }]);
        setStates([{ state: "Karnataka", district: "" }, { state: "Maharashtra", district: "" }]);
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="rp-form-card rp-form-wide">
      ...
      <div className="form-section" style={{ borderBottom: "none", paddingBottom: 0 }}>
        <div className="form-section-body">
          <div style={{
            ...
            <div>
              <p style={{ fontSize: "0.75rem", fontWeight: 700, color: "#1e40af", textTransform: "uppercase" }}>Onboarding New Office</p>
              <p style={{ fontSize: "0.72rem", color: "#3b82f6", textTransform: "uppercase", marginTop: "0.125rem" }}>Fill in all required fields marked with asterisk (*) to complete the onboarding process.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="form-section">
        <div className="rp-section-title">
          <FiFileText className="rp-section-icon" style={{ color: "#6366f1" }} /> BASIC INFORMATION
        </div>
        <div className="form-section-body">
      ...
      <div className="form-section">
        <div className="rp-section-title">
          <FiSettings className="rp-section-icon" style={{ color: "#f59e0b" }} /> OPERATIONAL DETAILS
        </div>
        <div className="form-section-body">
          <div className="form-grid">
            <InputField
      ...
      <div className="form-section">
        <div className="rp-section-title">
          <FiUser className="rp-section-icon" style={{ color: "#3b82f6" }} /> CONTACT PERSONS
        </div>
        <div className="form-section-body">
      ...
      <div className="form-section">
        <div className="rp-section-title">
          <FiLock className="rp-section-icon" style={{ color: "#10b981" }} /> LOGIN CREDENTIALS
        </div>
        <div className="form-section-body">
          <div className="form-grid">
            <InputField
      ...
      <div className="form-section">
        ...
        <div className="form-section-body">
          <div className="rp-info-banner" style={{ background: "#e0f2fe", color: "#0369a1", marginBottom: "1.5rem" }}>
            <span className="rp-info-icon">ℹ️</span>
            <span className="rp-info-text">
              <b>Document Upload Guidelines</b> Accepted formats: PDF, JPG, PNG
              (Max 5MB per file). Ensure all documents are clear and readable.
            </span>
          </div>
          <div className="form-grid">
      ...
      <div className="form-section">
        <div className="rp-section-title">
          <FiAlignLeft className="rp-section-icon" style={{ color: "#64748b" }} /> REMARKS / NOTES
        </div>
        <div className="form-section-body">
          <textarea
