export type OrgType = 'OFFICE' | 'INSTITUTION' | 'MOTOR_DRIVING_SCHOOL' | 'VENDOR';
...
export const initialOrganisations: Organisation[] = [
    ...
    {
        id: 5,
        name: 'CREATIVE SOLUTIONS VENDORS',
        type: 'VENDOR',
        domain: 'creativesolutions.com',
        regNumber: 'VND-998877',
        city: 'Bangalore',
        state: 'Karnataka',
        email: 'sales@creative.com',
        phone: '+91 8887776665',
    ...
    },
    {
        ...
        type: 'OFFICE',
        domain: 'globaltech.localhost',
        regNumber: 'UDYAM-12121212',
        city: 'Pune',
        state: 'Maharashtra',
    ...
    {
        id: 7,
        name: 'ST. JOSEPHS INSTITUTE',
        type: 'INSTITUTION',
        domain: 'stjosephs.edu',
        regNumber: 'SCH-445566',
        city: 'Mysore',
        state: 'Karnataka',
        email: 'office@stjosephs.edu',
        phone: '+91 6665554443',
        address: 'Vidyaranyapuram, Mysore',
        createdAt: '2024-06-15',
        status: 'Active',
    },
    {
        id: 8,
        name: 'SPEEDY WHEELS DRIVING',
        type: 'MOTOR_DRIVING_SCHOOL',
        domain: 'speedywheels.localhost',
        regNumber: 'MDS-112244',
        city: 'Dharwad',
        state: 'Karnataka',
        email: 'info@speedywheels.com',
        phone: '+91 5554443332',
        address: 'Court Road, Dharwad',
    ...
    },
    {
        ...
        name: 'OMNI SERVICES',
        type: 'VENDOR',
        domain: 'omniservices.com',
        regNumber: 'VND-554433',
        city: 'Chennai',
        state: 'Tamil Nadu',
    ...
    },
    {
        ...
        type: 'OFFICE',
        domain: 'nextgen.localhost',
        regNumber: 'UDYAM-90909090',
        city: 'Hyderabad',
        state: 'Telangana',
...
export const ORG_TYPES: OrgType[] = ['OFFICE', 'INSTITUTION', 'MOTOR_DRIVING_SCHOOL', 'VENDOR'];
