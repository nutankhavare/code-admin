        ...
        <div className="page">
            <div className="page-header">
                <div className="breadcrumb">
                    ORGANISATION <span>/ MANAGEMENT</span>
                </div>
            ...
            <div className="page-body">
                ...
                <div className="stat-grid stat-grid-4">
                    {[
                        { label: 'Offices', count: counts.OFFICE, color: '#6366f1', icon: '🏢' },
                        { label: 'Vendors', count: counts.VENDOR, color: '#f59e0b', icon: '🚚' },
                        { label: 'Institutions', count: counts.INSTITUTION, color: '#7c3aed', icon: '🎓' },
                        { label: 'MDS', count: counts.MOTOR_DRIVING_SCHOOL, color: '#10b981', icon: '🚗' }
                    ].map((card) => (
