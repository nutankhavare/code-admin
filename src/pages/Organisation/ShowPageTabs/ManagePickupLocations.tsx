...
import { FaMapMarkerAlt, FaFilter, FaCheckCircle, FaSearch, FaTimes } from 'react-icons/fa';
...
const ManagePickupLocations = () => {
    ...
    const fetchAssignedLocations = async () => {
        try {
            const response = await adminApi.get(
                `/Organisation/${id}/pickup-locations?type=${orgType}`
            );
    ...
    const handleSave = async () => {
        try {
            ...
            const response = await adminApi.post(`/Organisation/${id}/pickup-locations/assign`, {
