...
const initialPlans: Plan[] = [
  ...
  },
  {
    ...
    billing: "Monthly",
    users: 100,
    features: ["Advanced Tracking", "Priority Support", "25 GPS Devices", "Advanced Reports", "API Access"],
    status: "Active",
    subscribers: 89,
  },
  {
    ...
    billing: "Monthly",
    users: 500,
    features: ["Unlimited Tracking", "24/7 Support", "Unlimited Devices", "Custom Reports", "API Access", "White Label"],
    status: "Active",
    subscribers: 34,
  },
  {
